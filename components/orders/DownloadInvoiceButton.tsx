...
export const DownloadInvoiceButton: React.FC<DownloadInvoiceButtonProps> = ({ orderId }) => {
  ...
  const downloadInvoicePdf = async () => {
    ...
    try {
      ...
      const renderIcon = (name: keyof typeof icons, size = 18, color = 'currentColor', extraStyle = '') => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="${extraStyle}">${icons[name]}</svg>`;
        ...
        <body>
          ...
          <div class="main-box">
            ...
            <div class="main-col">
              ...
              <div class="mb-item">
                <div class="mb-icon">${renderIcon('shieldCheck')}</div>
                <div class="mb-content">Invoice Verification No.<strong>IVN-9A8B7C6D5E4F3G2</strong></div>
              </div>
            </div>
          </div>
