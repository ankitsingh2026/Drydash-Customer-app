...
const SECTIONS: Section[] = [
    ...
    },
    {
        ...
        description:
            "Users may permanently delete their DryDash account directly from the mobile application.",
        bullets: [
            "Account deletion is available from Profile → Edit Profile → Delete Account.",
            "Access to the account is disabled immediately after deletion confirmation.",
            "The account remains in a restricted state for 10 days after deletion.",
            "After 10 days, the account and associated personal data are permanently removed from our systems.",
            "Users may contact support within the 10-day period to request account restoration."
        ],
    },
    {
